...
public class MyStringController implements ItemController<String> {
    @Override
    public View setLogic(final Context context, String data, final int position, @ScrollCardPager.Mode int mode) {
